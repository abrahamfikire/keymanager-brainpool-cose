...
public class ECKeyPairGenRequestValidator {
    ...
    private void validateAllowedReferenceId(String applicationId, String refId) {
		...
		for (KeyReferenceIdConsts refConst : KeyReferenceIdConsts.values()) {
			LOGGER.info(KeymanagerConstant.SESSIONID, this.getClass().getSimpleName(), KeymanagerConstant.VALIDATE,
					"KeyReferenceIdConsts value: " + refConst.name());
		}
